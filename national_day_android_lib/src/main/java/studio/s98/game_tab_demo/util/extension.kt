...
suspend fun AwaitPointerEventScope.awaitMyLongPressOrCancellation(
    pointerId: PointerId
): PointerInputChange? {
...
suspend fun PointerInputScope.detectMyDragGesturesAfterLongPress(
    ...
    awaitEachGesture {
        try {
            ...
            val drag = awaitMyLongPressOrCancellation(down.id)
            if (drag != null) {
